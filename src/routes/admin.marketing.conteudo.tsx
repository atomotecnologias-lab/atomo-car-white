...
const CHANNELS: Channel[] = [
  ...
  },
  {
    ...
    build: (v) =>
      `${v.brand} ${v.model} ${v.version} ${v.year} disponível em Brusque/SC. ${v.km.toLocaleString("pt-BR")} km, procedência verificada, ${fmt(v.price)}. Aceitamos troca e financiamento. Agende seu test-drive na Primos Automóveis.`,
  },
  {
    key: "whatsapp",
    label: "WhatsApp",
